...
if __name__ == '__main__':
    ...
    image_path = '/home/sysadm/Debayan_BDA/ML/ML_Assignments/Assignment2_NBC/' #change your dataset path
    img_filename = 'band4.gif'

    img = plt.imread(''.join([image_path, img_filename]))   # why plt and not io?
